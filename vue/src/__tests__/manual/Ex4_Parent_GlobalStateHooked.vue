...
import { default as ChildA } from './Ex4_Child_PropsState_AUsed_Scoped.vue';
import { default as ChildB } from './Ex4_Child_PropsState_BUsed.vue';

const title = "Ex4_Parent_GlobalStateHooked"
